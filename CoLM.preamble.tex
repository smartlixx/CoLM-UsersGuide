...
\newcommand{\EngTitlePage}{%
   ...
   \vspace*{1in}
   \begin{center}
   \fontsize{22.5}{20}\selectfont {\bf Users' Guide of the Common Land Model\\[2ex] (CoLM 2024)}
   \end{center}
   \vskip 1in
   \textbf{\Large Coordinating Lead Authors:}\\
   {\large Shupeng Zhang, Xingjie Lu, Yongjiu Dai} \\[3ex]

   \noindent\textbf{\Large Lead Authors:}\\
   {\large Hua Yuan, Zhongwang Wei, Nan Wei, Xianxiang Li, Shaofeng Liu, Lu Li, Shulei Zhang, Chen Yang} \\[3ex]
}