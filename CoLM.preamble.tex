...
\newcommand{\EngTitlePage}{%
   ...
   \vspace*{1in}
   \begin{center}
   \fontsize{22.5}{20}\selectfont {\bf  The Common Land Model Version 2024 \\[2ex] Users' Guide}
   \end{center}
   \vskip 1in
   {\large Shupeng Zhang, Xingjie Lu, Zhongwang Wei, Hua Yuan, Nan Wei, Yongjiu Dai} \\[3ex]
}